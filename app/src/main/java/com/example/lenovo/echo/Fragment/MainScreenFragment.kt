...
import com.example.lenovo.echo.R.color.first
...
class MainScreenFragment : Fragment() {
    ...
    fun click() {
        recyclerView?.setOnClickListener(
            {
                val path = SongPlayingFragment.Statified.currentSongHelper?.songPath
                if (SongPlayingFragment.Statified.currentSongHelper?.isPlaying as Boolean) {
                    SongPlayingFragment.Statified.mediaPlayer?.stop()
                    SongPlayingFragment.Statified.mediaPlayer = null
                    SongPlayingFragment.Statified.mediaPlayer?.release()
                } else {
                    SongPlayingFragment.Statified.mediaPlayer = MediaPlayer()
                    SongPlayingFragment.Statified.mediaPlayer?.setAudioStreamType(AudioManager.STREAM_MUSIC)
                    SongPlayingFragment.Statified.mediaPlayer?.setDataSource(
                        SongPlayingFragment.Statified.myActivity,
                        Uri.parse(path)
                    )
                    SongPlayingFragment.Statified.mediaPlayer?.prepare()
                    SongPlayingFragment.Statified.mediaPlayer?.start()
                }
            }
        )
